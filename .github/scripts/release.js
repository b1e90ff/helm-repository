...
function createReleaseConfig(chartName, repositoryUrl) {
  ...
  "plugins": [
    ...
    ["@semantic-release/exec", {
      ...
      "publishCmd": "helm dependency build . && helm package . --destination ../packages/ && helm push ../packages/${dollar}{process.env.npm_package_name}-${dollar}{nextRelease.version}.tgz oci://ghcr.io/${dollar}{process.env.GITHUB_REPOSITORY_OWNER || 'b1e90ff'}"
    }],
